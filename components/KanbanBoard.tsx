...
const COLUMN_CONFIG: Array<ColConfig> = [
  { color: "bg-gray-400", icon: <Calendar className="h-4 w-4" /> },
  { color: "bg-blue-400", icon: <CheckCircle2 className="h-4 w-4" /> },
  { color: "bg-yellow-400", icon: <Mic className="h-4 w-4" /> },
  { color: "bg-green-400", icon: <Award className="h-4 w-4" /> },
  { color: "bg-red-400", icon: <XCircle className="h-4 w-4" /> },
];
      ...
      <DragOverlay>
        {activeJob ? (
          <div className="opacity-50">
            <JobApplicationCard job={activeJob} column={sortedColumns} />
          </div>
        ) : null}
      </DragOverlay>
    </DndContext>
